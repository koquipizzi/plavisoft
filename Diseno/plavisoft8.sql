...
INSERT INTO `cheque_runtime` VALUES (1,'882751','198283',700.00,'Juan Perez',1,'2014-10-20 21:01:03','2014-10-25'),(2,'882751','198283',700.00,'Juan Perez',1,'2014-10-20 21:01:03','2014-10-25');
...
INSERT INTO `forma_pago_pago` VALUES (1,14,5000.00);
...
INSERT INTO `imputacion` VALUES (43,14,1500.00,29),(44,14,1500.00,52),(45,14,1500.00,51),(46,14,500.00,50);
...
INSERT INTO `pago` VALUES (14,'2014-10-21',5000.00,'cinco mil ','','',10,'0001','0001');
...
/*!50001 VIEW `view_cuota_imputacion` AS select `c`.`id` AS `id`,`c`.`suscripcion_id` AS `suscripcion_id`,`c`.`valor` AS `valor`,sum(ifnull(`i`.`valor`,0)) AS `totalSaldado` from (`cuota` `c` left join `imputacion` `i` on((`c`.`id` = `i`.`cuota_id`))) group by `c`.`id`,`c`.`suscripcion_id`,`c`.`valor` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_cuota_saldo` AS select `cs`.`id` AS `id`,`cs`.`suscripcion_id` AS `suscripcion_id`,`cs`.`valor` AS `valor`,`cs`.`totalSaldado` AS `totalSaldado`,(`cs`.`valor` - `cs`.`totalSaldado`) AS `saldo` from `view_cuota_imputacion` `cs` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2014-10-21 15:31:32

...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $template='{view} {update} {delete} {conciliar}';
	/**
	 ...
	 */
	 ...
	 public $conciliarButtonLabel;
	/**
	 * @var string the image URL for the delete button. If not set, an integrated image will be used.
	 * You may set this property to be false to render a text link instead.
	 */
	public $conciliarButtonImageUrl;
	/**
	 * @var string a PHP expression that is evaluated for every delete button and whose result is used
	 * as the URL for the delete button. In this expression, the variable
	 * <code>$row</code> the row number (zero-based); <code>$data</code> the data model for the row;
	 * and <code>$this</code> the column object.
	 */
	public $conciliarButtonUrl='Yii::app()->controller->createUrl("addRecorrido",array("id"=>$data->primaryKey))';
	/**
	 * @var array the HTML options for the delete button tag.
	 */
	public $conciliarButtonOptions=array('class'=>'delete');
	/**
	 * @var string the confirmation message to be displayed when delete button is clicked.
	 * By setting this property to be false, no confirmation message will be displayed.
	 * This property is used only if <code>$this->buttons['delete']['click']</code> is not set.
	 */
	public $conciliarConfirmation;
	...
	protected function initDefaultButtons()
	{
		...
		if($this->conciliarButtonLabel===null)
			$this->conciliarButtonLabel=Yii::t('zii','Conciliar');
		...
		if($this->conciliarButtonImageUrl===null)
			$this->conciliarButtonImageUrl=$this->grid->baseScriptUrl.'/conciliar.png';
		if($this->conciliarConfirmation===null)
			$this->conciliarConfirmation=Yii::t('zii','Are you sure you want to delete this item?');
		

		foreach(array('view','update','delete','conciliar') as $id)
		{
			$button=array(
